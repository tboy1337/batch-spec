...
The package version is the contents of [`VERSION`](VERSION) (currently **0.32.0**). Releases are intended to be tagged `vMAJOR.MINOR.PATCH` matching that file. Pin a
