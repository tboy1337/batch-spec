...
- **Directory commands** - CD `/D` changes drive; with extensions, CD normalizes case and accepts unquoted paths with spaces; missing CD path leaves ERRORLEVEL 1; PUSHD/POPD stack; UNC temp drives from Z: down (PUSHD /?)
